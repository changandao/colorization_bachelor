...
while(length(find(abs(segI-step*cnt)<0.01))>0)
    pI=abs(segI-step*cnt)<0.01;
...
imshow(scrib)
path=strcat(imgDest,'scribble/',img(24:end),'p1.bmp');
imwrite(scrib,path);
